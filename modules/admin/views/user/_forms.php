...
<div class="user-form create_box">
    ...
    <?= $form->field($model, 'avatar', ['template' => '{label} <div class="row"><div class="col-sm-12">{input}<button type="button" class="layui-btn upload_button" id="test3"><i class="layui-icon"></i>上传文件</button>{error}{hint}</div></div>'])->textInput(['maxlength' => true, 'class' => 'layui-input upload_input']) ?>

    <?= Html::img($model->avatar, ['width' => '50', 'height' => '50', 'class' => 'layui-circle userinfo_head_pic']) ?>
