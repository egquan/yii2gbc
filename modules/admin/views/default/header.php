        ...
        <div class="header-menu">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item line-h50">
                    <a href="javascript:">
                        <img src="<?=Yii::$app->admin->identity->head_pic?>" class="layui-circle header_user_head_pic" width="30" height="30">
                        <cite class="header_user_name user-menu"><?=Yii::$app->admin->identity->nickname?></cite>
                    </a>
                    <dl class="layui-nav-child top-50">
                        <dd><a href="javascript:" class="changeSkin"><i
                                        class="iconfont icon-yifu userMenu"></i><cite>换肤</cite></a></dd>
